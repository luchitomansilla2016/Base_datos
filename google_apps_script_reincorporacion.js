  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .header-row { display: flex; align-items: flex-start; justify-content: flex-start; gap: 12px; margin-bottom: 30px; /* Sube 2 espacios el cuerpo */ }
      .membrete-img { width: 135px; height: auto; display: block; }
      .doc-title-container { flex: 1; text-align: center; padding-top: 58px; }
      .doc-title {
      ...
      .footer-sign-block { display: flex; justify-content: flex-end; align-items: flex-start; margin-top: 64px; /* Baja 1 espacio la postfirma y el sello */ margin-right: 23px; }
