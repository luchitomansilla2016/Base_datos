  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .header-row { display: flex; align-items: flex-start; justify-content: flex-start; gap: 12px; margin-bottom: 54px; /* Baja 3 espacios adicionales el cuerpo */ }
      .membrete-img { width: 135px; height: auto; display: block; }
      .doc-title-container { flex: 1; text-align: center; padding-top: 58px; /* Baja 3 espacios adicionales el título */ }
      .doc-title {
